...
# Configuration
# -------------------------------
BASE_MODEL = "/mnt/d/skinalor/model/Lingshu-32B"  # change to local path
ADAPTER_DIR = "/mnt/d/skinalor/model/Lingshu-7B-Finetuning/qwenvl/scripts/output30K"  # change to local path
USE_ADAPTER = True
