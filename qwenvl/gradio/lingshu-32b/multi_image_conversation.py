...
# Configuration
# -------------------------------
BASE_MODEL = "/home/william/model/Lingshu-32B"  # change to local path
ADAPTER_DIR = "/home/william/model/Lingshu-7B-Finetuning/qwenvl/scripts/output30K"  # change to local path
USE_ADAPTER = True
