...
# Configuration
# -------------------------------
BASE_MODEL = "/mnt/d/skinalor/model/Qwen2.5-VL-7B-Instruct"  # change to local path
ADAPTER_DIR = "/mnt/d/skinalor/model/Lingshu-7B-Finetuning/qwenvl/scripts/output"  # change to local path
USE_ADAPTER = True
