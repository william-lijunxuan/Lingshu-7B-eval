...
from evaldatasets.utils.Logger_util import Logger
...
parser.add_argument(
    "--config_model_name",
    type=str,
    default="medgemma_1_5_4b",
    help="name of model, e.g. Lingshu, MedVLM_R1, medgemma_4b_it,Hulu_Med_7B,medgemma_1_5_4b"
)
