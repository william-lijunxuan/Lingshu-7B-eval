...
class Skingpt(BaseDataset):
    def __init__(self,idx,model,dataset_path,output_path):
        ...
        self.eval_local_datasets_file = str(os.environ.get("eval_local_datasets_file", "/mnt/d/skinalor/dataset/skin/SKINgpt/20250711055029_SKINgpt_multiple_choice_QA.json"))
    ...
    def construct_messages(self,sample):
        ...
        if "close_end_QA"==type:
            ...
            """
        img_path = os.path.join("/mnt/d/skinalor/dataset/skin/SKINgpt/image", sample["image_name"])
