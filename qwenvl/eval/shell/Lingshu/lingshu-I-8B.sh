...
# output config
OUTPUT_PATH="eval_results/Lingshu-I-8B"

# VLM model config
MODEL_PATH="/root/model/Lingshu-I-8B"
MODEL_NAME="InternVL3"
CONFIG_MODEL_NAME="InternVL3"
#ADAPTER_PATH="/root/model/Lingshu-7B-Finetuning/qwenvl/scripts/output"
#ADAPTER_PATH="/root/model/Lingshu-7B-Finetuning/output"
ADAPTER_PATH=None
